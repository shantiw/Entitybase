...
namespace Shantiw.Data.DataAnnotations
{
    ...
    {
        public static DescriptionAttribute CreateDescriptionAttribute(XElement xAnnotation)
        {
            if (xAnnotation.GetAttributeValue(SchemaVocab.Type) != nameof(DescriptionAttribute)) throw new ArgumentException(xAnnotation.ToString());

            DescriptionAttribute attribute = new(xAnnotation.GetAttributeValue(nameof(DescriptionAttribute.Description)));
